...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>This console is primarily used for Account Manager to manage their Accounts and Opportunities.</description>
    ...
    <label>Opportunity Management Console</label>
    <listPlacement>
