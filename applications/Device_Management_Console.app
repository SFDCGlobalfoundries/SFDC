...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>This console can be used by the FAE, FTS and CE to manage customer devices.</description>
    ...
    <label>Device Management Console</label>
    <listPlacement>
        <location>full</location>
    </listPlacement>
    <listRefreshMethod>refreshList</listRefreshMethod>
    <logo>Graphics_Pack_for_Tabs/computer_png3.png</logo>
    ...
    <workspaceMappings>
        <mapping>
            <fieldName>Opportunity_Program__c</fieldName>
            <tab>Device__c</tab>
        </mapping>
        <mapping>
